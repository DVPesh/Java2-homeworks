...
public class Cat implements Able, Convertable {
    ...
    public Cat(String nickname, Color color, float jumpLimit, Unit jumpLimitUnit, float runLimit, Unit runLimitUnit) {
        this(nickname, color);
    ...
    public String toString() {
        return String.format("%s кот %s", color.getInRussian(), nickname);
    }
}
